...
export default class JavaScriptPage {
    public get btnIntroduction() {
        return $('//android.widget.TextView[@resource-id="com.ubproject.learnautomationtesting:id/textView1"]');
    }

    public get txtIntroduction() {
        return $('//*[@resource-id="com.ubproject.learnautomationtesting:id/title"]');
    }
